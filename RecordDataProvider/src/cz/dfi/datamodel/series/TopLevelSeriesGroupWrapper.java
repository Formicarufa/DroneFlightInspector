 ...
 * The other implementation of {@link SeriesGroupWrapper}  does
 * not contain the time information itself. However, it has to have parent which
 * is able to provide the time information when needed.
 * Instance of this class does not have to have parent.
 * Class is instantiated through static method 
...
class TopLevelSeriesGroupWrapper extends SeriesGroupWrapper {
     ...
     * @param timeStamps Array of time stamps associated with the values of series subsumed into this group
     */
