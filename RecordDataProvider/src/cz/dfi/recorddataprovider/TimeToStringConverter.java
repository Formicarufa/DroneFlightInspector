 ...
 * If the user wants to redefine the way how these numbers are interpreted he or she should
 * implement this interface, create an instance of the implementing class and put it into the file lookup.
 * (default is: number of nanoseconds since 1970 for both on-board time and recording time)
