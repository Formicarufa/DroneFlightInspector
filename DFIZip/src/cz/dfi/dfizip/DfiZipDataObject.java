...
@Messages({
    "LBL_DfiZip_LOADER=Files of DfiZip"
})
...
@DataObject.Registration(
        mimeType = "application/zip",
        iconBase = "cz/dfi/dfizip/box.png",
        displayName = "#LBL_DfiZip_LOADER",
        position = 300
)
@ActionReferences({
    @ActionReference(
            path = "Loaders/application/zip/Actions",
...
public class DfiZipDataObject extends MultiDataObject {
    ...
    public DfiZipDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
        getCookieSet().add((Node.Cookie) new DfiZipOpenSupport(getPrimaryEntry()));
    }
